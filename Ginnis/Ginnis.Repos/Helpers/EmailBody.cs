            ...
            <body style = ""margin:0; padding:0"">
                <div style = ""height: auto; background: linear-gradient(to top, pink, white) no-repeat;"">
                    <div>
                        ...
                        <a href=""http://localhost:4200/account/reset-password?email={email}&code={emailToken}"" target=""_blank""  style = ""background:red; padding:10px; border:none; color:white; border-radius:4px; display:block; width:25%; text-align:center; text-decoration:none"">Reset Password </a><br>
